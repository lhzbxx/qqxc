...
.controller('HomeCtrl', function($scope, $cordovaToast, $location, $rootScope, $ionicLoading, $ionicPopup, $http, $cordovaGeolocation) {
    ...
    $scope.show = function() {
        $ionicLoading.show({
            template: '<ion-spinner icon="bubbles" class="spinner-light"></ion-spinner><br>Loading...<style>.spinner svg {width: 50px !important; height: 50px !important;}</style>',
            duration: 1000
        });
    };
    $scope.hide = function() {
    ...
    $scope.getPos = function() {
        $ionicLoading.show({
            template: '<ion-spinner icon="bubbles" class="spinner-light"></ion-spinner><br>正在定位...<style>.spinner svg {width: 50px !important; height: 50px !important;}</style>',
        });
        $cordovaGeolocation
